...
module ScaleRb
  RSpec.describe "Encoding Tests" do
    ...
    it "should encode array" do
      bytes = ScaleRb::Codec.encode 1, ScaleRb::Utils.hex_to_u8a('0x1234567812345678123456781234567812345678123456781234567812345678'), @types
    ...
    it "should encode a composite which only has one item without a name" do
      bytes = ScaleRb::Codec.encode 0, [ScaleRb::Utils.hex_to_u8a('0x1234567812345678123456781234567812345678123456781234567812345678')], @types
      expect(bytes).to eql([0x12, 0x34, 0x56, 0x78] * 8)
