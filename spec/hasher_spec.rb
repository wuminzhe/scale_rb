...
module ScaleRb
  RSpec.describe Hasher do
    it 'can hash with twox128' do
      expect(Hasher.twox128('System')).to eql('26aa394eea5630e07c48ae0c9558cef7'.to_bytes)
      expect(Hasher.twox128('Account')).to eql('b99d880ec681799c0cf30e8886371da9'.to_bytes)
    end
    ...
    it 'can hash with Blake2128Concat' do
      ...
      expect(result).to eql(
        '4bab0fcfc536fa263f3b241cd32f76a8724d50824542b56f422588421643c4a162b90b5416ef063f2266a1eae6651641'.to_bytes
      )
