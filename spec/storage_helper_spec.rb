...
module ScaleRb
  RSpec.describe StorageHelper do
    ...
    it 'can encode storage key without param' do
      ...
      storage_key = Utils.u8a_to_hex(storage_key)
      expect(storage_key).to eql('0x26aa394eea5630e07c48ae0c9558cef70a98fdbe9ce6c55837576c60c7af3850')
    end

    it 'can encode storage key with one param' do
      # account_id
      key = {
        value: [Utils.hex_to_u8a('0x724d50824542b56f422588421643c4a162b90b5416ef063f2266a1eae6651641')],
        type: 0,
    ...
    it 'can encode storage key with two param(same hasher)' do
      storage_key = StorageHelper.encode_storage_key(
        ...
        'AuthoredBlocks',
        {
          value: [123, Utils.hex_to_u8a('0x724d50824542b56f422588421643c4a162b90b5416ef063f2266a1eae6651641')], # U32, AccountId
          type: 291, # 291 => [4, 0]
    ...
    it 'can encode storage key with two param(different hasher)' do
      storage_key = StorageHelper.encode_storage_key(
        ...
        {
          value: [
            Utils.hex_to_u8a('0x724d50824542b56f422588421643c4a162b90b5416ef063f2266a1eae6651641'), # AccountId
            Utils.hex_to_u8a('0x0101010101010101010101010101010101010101010101010101010101010101') # [U8; 32] array
          ],
          type: 582, # 582 => [0, 1]
    ...
    it 'can decode system events' do
      metadata = Metadata::Metadata.from_json(File.read('./spec/assets/darwinia-metadata.1243.json'))
